...
// AlertDialog is built on top of base-ui Dialog since base-ui has no dedicated AlertDialog primitive.
// It intentionally removes the close-on-backdrop-click behaviour to match alert dialog semantics.
